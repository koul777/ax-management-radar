  ...
  plainSummary: [
    {
      ...
      body: "스스로 문제를 찾고 끝까지 밀고 가는 성향, 그리고 자신의 일이 사회에 도움이 된다고 느끼는 정도가 혁신행동과 연결되었습니다. 통합 리더십은 공공 β=.102(p=.051), 민간 β=.005(p=.915)로 p<.05 기준의 통계적 근거가 충분하지 않았습니다. 효과가 없다는 증명은 아닙니다.",
    },
    {
      label: "현재 수준 차이",
