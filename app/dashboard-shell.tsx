...
import PublicInstitutionDashboard from "./public-institution-dashboard";
import { useManualTabFocus } from "./tab-navigation";

export type DashboardMenu = "ax" | "hccp" | "public-private" | "central-local" | "public-data" | "public-institutions" | "klips" | "personal-ai" | "citizen" | "research";
