...
export default async function Home({ searchParams }: { searchParams: Promise<{ view?: string | string[]; section?: string | string[]; year?: string | string[]; private_size?: string | string[] }> }) {
  ...
  const initialMenu: DashboardMenu = view === "hccp" || view === "public-private" || view === "central-local" || view === "public-data" || view === "public-institutions" || view === "klips" || view === "personal-ai" || view === "citizen" || view === "research" ? view : "ax";
